...
You must format your output such that each letter is replaced by a randomly chosen sentence corresponding to that letter from the following mapping:
...
Any character that is not in the mapping must be left as-is. Lowercase letters should be mapped to uppercase letters before translating using the mapping.
"""
