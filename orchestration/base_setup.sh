...
uv pip install tensordict==0.7.2 peft duckdb jupyterlab evaluate sacrebleu cachetools asyncache httpx-aiohttp orjson adamw-bf16 setuptools psycopg2-binary javalang flair together plotly kaleido
