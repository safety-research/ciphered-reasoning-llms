...
def init_ray_actors():
    ...
    for model in MODELS:
        ...
        actor = VllmActor.remote(
            model_path=f"/home/ubuntu/sky_workdir/encoding-schemes/output/{model_id}/sft_model/last",
...
def send_message():
    ...
    response_content = ray.get(
        actor.chat.remote(conversation_messages, {})
    )
    return jsonify({
...
if __name__ == '__main__':
    ...
    context = ('/etc/letsencrypt/live/cipheredreasoning.app/fullchain.pem', '/etc/letsencrypt/live/cipheredreasoning.app/privkey.pem')
